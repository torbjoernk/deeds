...
And /^the User visits '\/archives'$/ do
  visit archives_path
end
...
And /^enters the new Archive's title$/ do
...
And /^the User clicks on the "([^"]*)" button of the first Archive$/ do |arg|
...
And /^changes the Archive's title$/ do
